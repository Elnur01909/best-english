...
export default function DailySchedule() {
  ...
  const SESSIONS = [
    { id: 'midday',  emoji: '☀️', label: 'Hüquqi Oxu',     desc: `"${curriculum.title_en}" mətni — sözləri kontekstdə gör`,  route: `/reading?passageId=${curriculum.reading_id}&topics=${topicParam}` },
